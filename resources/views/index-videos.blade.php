...
<!-- Mirrored from deothemes.com/envato/deus/html/index-videos by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 04:43:56 GMT -->
<head>
  <title>Deus | Home 5 Videos</title>
      ...
      <div class="nav__holder nav--sticky">
        <div class="container relative">
          <div class="flex-parent">
            ...
            <!-- Logo -->
            <a href="/" class="logo">
              <img class="logo__img" src="img/logo_videos.png" srcset="img/logo_videos.png 1x, img/logo_videos@2x.png 2x" alt="logo">
            </a>
                        ...
                        <div class="row">
                            ...
                            <article class="entry">
                              ...
                              <div class="entry__body">   
                                <h2 class="entry__title">
                                  <a href="single-post-videos">Follow These Smartphone Habits of Successful Entrepreneurs</a>
                                </h2>
                              </div>
                            </article>
                          </div>
                          ...
                          <div class="col nav__megamenu-item">
                            <article class="entry">
                              ...
                              <div class="entry__body">   
                                <h2 class="entry__title">
                                  <a href="single-post-videos">3 Things You Can Do to Get Your Customers Talking About Your Business</a>
                                </h2>
                              </div>
                            </article>
                          </div>
                          ...
                          <div class="col nav__megamenu-item">
                            <article class="entry">
                              ...
                              <div class="entry__body">   
                                <h2 class="entry__title">
                                  <a href="single-post-videos">Lose These 12 Bad Habits If You're Serious About Becoming a Millionaire</a>
                                </h2>
                              </div>
                            </article>
                          </div>
                          ...
                          <div class="col nav__megamenu-item">
                            <article class="entry">
                              ...
                              <div class="entry__body">   
                                <h2 class="entry__title">
                                  <a href="single-post-videos">10 Horrible Habits You're Doing Right Now That Are Draining Your Energy</a>
                                </h2>
                              </div>
                            </article>
                          </div>
            ...
            <article class="entry thumb thumb--size-4">
              <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/hero/hero_post_13.jpg');">
                ...
                <div class="thumb-text-holder thumb-text-holder--3">
                  <a href="categories" class="entry__meta-category entry__meta-category--label entry__meta-category--violet">World</a>
                  ...
                  <h2 class="thumb-entry-title">
                    <a href="single-post-videos">People Who Take Cold Showers Take Fewer Sick Days, Study Finds</a>
                  </h2>
                </div>
                <a href="single-post-videos" class="thumb-url"></a>
              </div>
            </article>
          ...
          <div class="col-lg-6">
            ...
            <article class="entry thumb thumb--size-4">
              <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/hero/hero_post_14.jpg');">
                <div class="bottom-gradient"></div>
                <div class="thumb-text-holder thumb-text-holder--3">
                  <a href="categories" class="entry__meta-category entry__meta-category--label entry__meta-category--cyan">Technology</a>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <span>by</span>
                      <a href="#">DeoThemes</a>
          ...
          <div class="video-playlist__list">
            <a href="https://www.youtube.com/embed/SVnhBjRMlKA?feature=oembed&amp;autoplay=1" class="video-playlist__list-item video-playlist__list-item--active">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/SVnhBjRMlKA/default.jpg" src="../../../../i.ytimg.com/vi/SVnhBjRMlKA/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
            ...
            <a href="https://www.youtube.com/embed/MY0UBGX2FtA?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/MY0UBGX2FtA/default.jpg" src="../../../../i.ytimg.com/vi/mn6Ia5e_suY/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
              <div class="video-playlist__list-item-description">
                <h4 class="video-playlist__list-item-title">iPhone X Review – Pushing Me to Android</h4>
              </div>
            ...
            <article class="entry thumb thumb--size-5 thumb--mb-20">
              <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/thumb/thumb_post_5.jpg');">
                ...
                <div class="thumb-text-holder thumb-text-holder--3">
                  <a href="categories" class="entry__meta-category entry__meta-category--label entry__meta-category--violet">World</a>
                  <h2 class="thumb-entry-title">
                    <a href="single-post-videos">6 Personal Fears Holding You Back From Your Dream Career</a>
                  </h2>
                  ...
                  <div class="entry__body">
                    <div class="entry__header">                      
                      <h2 class="entry__title entry__title--sm">
                        <a href="single-post-videos">How to Bounce Back After a Business Venture Fails</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <span>by</span>
            ...
            <article class="entry">
              ...
              <div class="entry__body">
                <div class="entry__header">
                  ...
                  <h2 class="entry__title">
                    <a href="single-post-videos">UN’s WFP Building Up Blockchain-Based Payments System</a>
                  </h2>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <span>by</span>
            ...
            <ul class="post-list-small post-list-small--2">
                ...
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="single-post-videos">Deep Rock Galactic Is A Cooperative Blast</a>
                    </h3>
                  </div>                  
                </article>
              </li>
              ...
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="single-post-videos">Amnesty says global superpowers are 'callously undermining the rights of millions'</a>
                    </h3>
                  </div>                  
                </article>
              </li>
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  ...
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="single-post-videos">Extreme Heat Waves Will Change How We Live. We’re Not Ready</a>
                    </h3>
                  </div>                  
                </article>
              </li>
        ...
        <div id="owl-posts" class="owl-carousel owl-theme owl-carousel--arrows-outside">
          ...
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_10.jpg');">
              ...
              <div class="thumb-text-holder">   
                <h2 class="thumb-entry-title">
                  <a href="single-post-videos">Want to be More Successful? Go to Bed</a>
                </h2>
              </div>
              <a href="single-post-videos" class="thumb-url"></a>
            </div>
          ...
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_11.jpg');">
              ...
              <div class="thumb-text-holder">   
                <h2 class="thumb-entry-title">
                  <a href="single-post-videos">Your Brand Plan Is More Important Than Your Business</a>
                </h2>
              </div>
              <a href="single-post-videos" class="thumb-url"></a>
            </div>
          ...
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_12.jpg');">
              ...
              <div class="thumb-text-holder">   
                <h2 class="thumb-entry-title">
                  <a href="single-post-videos">6 Tell-Tale Signs You're Underpaid</a>
                </h2>
              </div>
              <a href="single-post-videos" class="thumb-url"></a>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
              <aside class="widget widget-logo">
                <a href="/">
                  <img src="img/logo_videos.png" srcset="img/logo_videos.png 1x, img/logo_videos@2x.png 2x" class="logo__img" alt="">
                </a>
                <p class="mt-24">We bring you the most advanced themes that perfect for news, magazine, personal blog, etc. Check our landing page for details.</p>
                <p class="mb-32">
                  Contact us: <a href="https://deothemes.com/">deothemes.com</a>
                </p>
...
<!-- Mirrored from deothemes.com/envato/deus/html/index-videos by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 04:44:13 GMT -->
</html>