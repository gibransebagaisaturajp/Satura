...
<!-- Mirrored from deothemes.com/envato/deus/html/index-music by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 04:44:13 GMT -->
<head>
  <title>Deus | Home 6 Music</title>
            ...
            <div class="hero-slider-1__thumb-text-holder">
              <div class="container"> 
                <h2 class="hero-slider-1__entry-title">
                  <a href="single-post-music">Meghan Trainor and 'Queer Eye' Cast Team Up for Spotify Takeover: Listen</a>
                </h2>
              </div>
            </div>
          </article>          
        ...
        <div class="carousel-cell hero-slider-1__item">
          <article class="hero-slider-1__entry entry">
            ...
            <div class="hero-slider-1__thumb-text-holder">
              <div class="container"> 
                <h2 class="hero-slider-1__entry-title">
                  <a href="single-post-music">WATCH Suprise Performance, Shoots Whiskey at Nashville’s Bluebird Cafe</a>
                </h2>
              </div>
            </div>
          </article>          
        ...
        <div class="carousel-cell hero-slider-1__item">
          <article class="hero-slider-1__entry entry">
            ...
            <div class="hero-slider-1__thumb-text-holder">
              <div class="container"> 
                <h2 class="hero-slider-1__entry-title">
                  <a href="single-post-music">'American Idol': How the Show's Inclusive New Season Reflects the Country's Progress</a>
                </h2>
              </div>
            </div>
          </article>          
    ...
    <div class="main-container container content-box content-box--pt-108" id="main-container">
        ...
        <div id="owl-posts-3-items" class="owl-carousel owl-theme owl-carousel--arrows-outside">
          <article class="entry card card--1">
            <div class="entry__img-holder card__img-holder">
              <a href="single-post-music">
                <div class="thumb-container thumb-70">
                  <img data-src="img/content/carousel/carousel_post_13.jpg" src="img/empty.png" class="entry__img lazyload" alt="" />
            ...
            <div class="entry__body card__body">
              <div class="entry__header">
                ...
                <h2 class="entry__title">
                  <a href="single-post-music">ROMANCING THE CLASSICS - PPO 35th Concert Season 2017–2018</a>
                </h2>
                <ul class="entry__meta">
          ...
          <article class="entry card card--1">
            <div class="entry__img-holder card__img-holder">
              <a href="single-post-music">
                <div class="thumb-container thumb-70">
                  <img data-src="img/content/carousel/carousel_post_14.jpg" src="img/empty.png" class="entry__img lazyload" alt="" />
                  <div class="entry-date-label">
            ...
            <div class="entry__body card__body">
              <div class="entry__header">
                ...
                <h2 class="entry__title">
                  <a href="single-post-music">FOUR - An Anniversary Show, With Special Guest "BEN &amp; BEN"</a>
                </h2>
                <ul class="entry__meta">
                  <li class="entry__meta-author">
                    <span>by</span>
          ...
          <article class="entry card card--1">
            <div class="entry__img-holder card__img-holder">
              <a href="single-post-music">
                <div class="thumb-container thumb-70">
                  <img data-src="img/content/carousel/carousel_post_15.jpg" src="img/empty.png" class="entry__img lazyload" alt="" />
                  <div class="entry-date-label">
            ...
            <div class="entry__body card__body">
              <div class="entry__header">
                ...
                <h2 class="entry__title">
                  <a href="single-post-music">Tickets For Sam Smith's Show in Manila in October Go On Sale Next Week!</a>
                </h2>
                <ul class="entry__meta">
                  <li class="entry__meta-author">
                    <span>by</span>
          ...
          <div class="video-playlist__list">
            <a href="https://www.youtube.com/embed/E0wW9RwpG7M?feature=oembed&amp;autoplay=1" class="video-playlist__list-item video-playlist__list-item--active">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/E0wW9RwpG7M/default.jpg" src="../../../../i.ytimg.com/vi/E0wW9RwpG7M/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
            ...
            <a href="https://www.youtube.com/embed/7TWkmy5ELJc?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/7TWkmy5ELJc/default.jpg" src="../../../../i.ytimg.com/vi/mn6Ia5e_suY/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
              <div class="video-playlist__list-item-description">
            ...
            <a href="https://www.youtube.com/embed/hXnMSaK6C2w?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/hXnMSaK6C2w/default.jpg" src="../../../../i.ytimg.com/vi/mn6Ia5e_suY/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
              <div class="video-playlist__list-item-description">
            ...
            <a href="https://www.youtube.com/embed/xMTsul4UFl8?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/xMTsul4UFl8/default.jpg" src="../../../../i.ytimg.com/vi/mn6Ia5e_suY/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
              <div class="video-playlist__list-item-description">
            ...
            <a href="https://www.youtube.com/embed/2Vv-BfVoq4g?feature=oembed&amp;autoplay=1" class="video-playlist__list-item">
              <div class="video-playlist__list-item-thumb">
                <img data-src="https://i.ytimg.com/vi/2Vv-BfVoq4g/default.jpg" src="../../../../i.ytimg.com/vi/mn6Ia5e_suY/default.jpg" class="video-playlist__list-item-img lazyload" alt="">
              </div>
              <div class="video-playlist__list-item-description">
      ...
      <section class="section mb-24">
        ...
        <div class="row row-20">
              ...
              <div class="entry__img-holder">
                <a href="single-post-music">
                  <div class="thumb-container thumb-65">
                    <img data-src="img/content/grid/grid_post_33.jpg" src="img/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
          ...
          <div class="col-md-6">
            <article class="entry thumb thumb--size-3 thumb--mb-20">
              <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/grid/grid_post_34.jpg');">
                <div class="bottom-gradient"></div>
                ...
                <a href="single-post-music" class="thumb-url"></a>
              </div>
            </article>
          </div>
          <div class="col-md-3">
            <article class="entry">
              <div class="entry__img-holder">
                <a href="single-post-music">
                  <div class="thumb-container thumb-65">
                    <img data-src="img/content/grid/grid_post_35.jpg" src="img/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
              ...
              <div class="entry__body">
                <div class="entry__header">                    
                  <h2 class="entry__title">
                    <a href="single-post-music">Zedd, Maren Morris &amp; Grey's 'The Middle' Hits No. 1 on Pop Songs Airplay Chart</a>
                  </h2>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <span>by</span>
        ...
        <div class="row row-20">
          <div class="col-md-6">
            <article class="entry thumb thumb--size-3 thumb--mb-20">
              <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/grid/grid_post_36.jpg');">
                <div class="bottom-gradient"></div>
                <div class="thumb-text-holder thumb-text-holder--2">
                  <ul class="entry__meta">
                    <li>
          ...
          <div class="col-md-3">
            <article class="entry">
              <div class="entry__img-holder">
                <a href="single-post-music">
                  <div class="thumb-container thumb-65">
                    <img data-src="img/content/grid/grid_post_37.jpg" src="img/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
              ...
              <div class="entry__body">
                <div class="entry__header">                    
                  <h2 class="entry__title">
                    <a href="single-post-music">Download Festival Rocks Melbourne, Prepares to Expand in 2019</a>
                  </h2>
                  <ul class="entry__meta">
                    <li class="entry__meta-author">
                      <span>by</span>
          ...
          <div class="col-md-3">
            <article class="entry">
              <div class="entry__img-holder">
                <a href="single-post-music">
                  <div class="thumb-container thumb-65">
                    <img data-src="img/content/grid/grid_post_38.jpg" src="img/empty.png" class="entry__img lazyload" alt="">
                  </div>
                </a>
              </div>
      ...
      <section class="section mb-0">
        ...
        <div id="owl-posts" class="owl-carousel owl-theme owl-carousel--arrows-outside">
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_16.jpg');">
              <div class="bottom-gradient"></div>
          ...
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_17.jpg');">
              <div class="bottom-gradient"></div>
              <div class="thumb-text-holder">   
                <h2 class="thumb-entry-title">
                  <a href="single-post-music">Jack, Chris &amp; More to Headline 2018 Pilgrimage Festival</a>
          ...
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_18.jpg');">
              <div class="bottom-gradient"></div>
              <div class="thumb-text-holder">   
                <h2 class="thumb-entry-title">
                  <a href="single-post-music"> 9 Standout moments of Demi Lovato’s Tell Me You</a>
                </h2>
              </div>
              <a href="single-post-music" class="thumb-url"></a>
            </div>
          ...
          <article class="entry thumb thumb--size-1">
            <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/content/carousel/carousel_post_19.jpg');">
              <div class="bottom-gradient"></div>
              <div class="thumb-text-holder">   
                <h2 class="thumb-entry-title">
                  <a href="single-post-music">Which Artist Is Dominating 2018 So Far? Vote!</a>
                </h2>
              </div>
              <a href="single-post-music" class="thumb-url"></a>
            </div>
...
<!-- Mirrored from deothemes.com/envato/deus/html/index-music by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jun 2019 04:44:54 GMT -->
</html>